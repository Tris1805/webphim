                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a
                                        href="{{ route('country', [$movie->genre->slug]) }}">{{ $movie->genre->title }}</a>
                                    »
                                    <span><a
            ...
            <section id="content" class="test">
                <div class="clearfix wrap-content">
                    <div id="player">
                        ...
                        <iframe width="100%" height="500" src="{{ $ep->linkphim }}" title="YouTube video player"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen id="play_area"></iframe>
                        {{-- <video src="{{ $ep->linkphim }}"></video> --}}
                        {{-- <video src="" id="my-video" controls></video> --}}
                        {{-- <video id="player-demo" width="100%" height="70%" preload="none" style="max-width: 100%"
                            controls="" poster="images/big_buck_bunny.jpg">
                            <source src="{{ $ep->linkphim }}" type="video/mp4">
                            <!-- Just add multiple <track> files, they get integrated automatically -->
                            <track src="dist/mediaelement.vtt" srclang="en" label="English" kind="captions"
                                type="text/vtt">
                            <track src="dist/mediaelement_german.vtt" srclang="de" label="Deutsch" kind="subtitles"
                                type="text/vtt">
                        </video> --}}
                                        ...
                                        @foreach ($movie->episode as $key => $sotap)
                                            <a href="{{ url('xem-phim/' . $movie->slug . '/tap-' . $sotap->episode) }}">
                                                <li class="halim-episode"><span
                                                        class="halim-btn halim-btn-2 {{ $sotap->episode == $tapphim ? 'active' : '' }} halim-info-1-1 box-shadow"
