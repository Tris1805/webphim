...
<body class="cbp-spmenu-push">
                ...
                <aside class="sidebar-left">
                    <nav class="navbar navbar-inverse">
                        <div class="navbar-header">
                            ...
                            <h1>
                                <a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span>
                            ...
                            <ul class="sidebar-menu">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('category.index') }}"><i
                                                    class="fa fa-angle-right"></i>Liệt
                                                kê
                                                danh
                                                mục</a>
                                        </li>
                                ...
                                <li class="treeview {{ $segment == 'movie' ? 'active' : '' }}">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('movie.index') }}"><i class="fa fa-angle-right"></i>Liệt
                                                kê
                                                phim</a>
                                        </li>
                                    </ul>
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('episode.index') }}"><i class="fa fa-angle-right"></i>Liệt
                                            kê tập
                                            phim</a>
                                    </li>
                                </ul>
    ...
    <script type="text/javascript">
        $('.select-season').change(function() {
            const season = $(this).find(':selected').val();
            const id_film = $(this).attr('id');
    ...
    <script type="text/javascript">
        $('.select-topview').change(function() {
            const topview = $(this).find(':selected').val();
            const id_film = $(this).attr('id');
            if (topview == 0) {
                var text = 'Ngày'
            } else if (topview == 1) {
    ...
    <script type="text/javascript">
        ...
        $('.choose_ToM').change(function() {
            let ToM = $(this).val();
            let movie_id = $(this).attr('id');
            $.ajax({
                url: "{{ route('choose-ToM') }}",
                method: "GET",
                data: {
                    ToM: ToM,
                    movie_id: movie_id
        ...
        $('.choose_resolution').change(function() {
            let resolution = $(this).val();
            let movie_id = $(this).attr('id');
            $.ajax({
                url: "{{ route('choose-resolution') }}",
                method: "GET",
                data: {
    ...
    <script type="text/javascript">
        $(document).on('change', '.file-image', function() {
            ...
            const files = $("#file-" + movie_id)[0].files;
            const form_data = new FormData();
            const image = document.getElementById("file-" + movie_id).files[0];
            form_data.append('file', document.getElementById("file-" + movie_id).files[0]);
            form_data.append('movie_id', movie_id);
            $.ajax({
                url: "{{ route('choose-updateImage') }}",
                method: "POST",
                headers: {
                ...
                success: function(data) {
                    location.reload();
                    // $('#error_image').html(
                    //     '<span class="text-success">Cập nhật hình ảnh thành công</span>')
